...
|-------------------|:-------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| noSQL             |    MongoDB    | - Doesn’t have a structured data model <br/> - Optimized for storing documents <br/> - Can be used to store time series data <br/> - Uses MongoDB query language                                                                                                              | - It is able to scale<br/> - Good write speed                                                                                                                                         | -MongoDB query language differs greatly from SQL query language                                                                                       |
|                   |   Cassandra   | - Distributed columnar database <br/> - Can be used to store time series data <br/> - Uses CQL query language (similar to SQL but less flexible) <br/> -Uses CQL query language (similar to SQL but less flexible)                                                            | - It is able to scale<br/> - Good write speed                                                                                                                                         | - Does not support global indexes<br/> - Does not support joins and sub queries<br/>- CQL complicates workloads that require heavy analytical queries |
