...
![Trends in the database industry.](/images/blog/timeseries2022/trends_databases_2022.png#center)
...
|-------------------|:-------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| noSQL             |    MongoDB    | - Doesn't have a structured data mode <br/>- Optimized for storing documents <br/> - Can be used to store time series data <br/>- Uses MongoDB query language                                                                                                                 | - It is able to scale<br/> - Good write speed                                                                                                                                         | -MongoDB query language differs greatly from SQL query language                                                                                       |                                                                                                                                                                                                                                      |                                                                                                                                                                                       |                                                                                                                                                       |
| noSQL             |   Cassandra   | - Distributed columnar database <br/> - Can be used to store time series data <br/> - Uses CQL query language (similar to SQL but less flexible) <br/> -Uses CQL query language (similar to SQL but less flexible)                                                            | - It is able to scale<br/> - Good write speed                                                                                                                                         | - Does not support global indexes<br/> - Does not support joins and sub queries<br/>- CQL complicates workloads that require heavy analytical queries |
| SQL               |  PostgreSQL   | - Relational data model <br/> - Optimized for tabular storage of related data in rows and columns<br/> - Uses SQL query language                                                                                                                                              | - Does not scale well, users tend to shift to a noSQL database when they hit a certain scale<br/> - The performance can be improved if the database is optimized for time series data | - It is optimized to do updates over inserts, so typically it doesn't scale well with time series data                                                |
| Time series       | Timescale DB  | - Optimized for collecting, storing, retrieving and processing time series data <br/> - Constructed on top of PostgreSQL<br/> -It’s relational and time series simultaneously<br/>-Uses SQL query language<br/> -Built-in functions to perform time series data analysis<br/> | -Has a accelerated performance and is able to scale.                                                                                                                                  | -Indexes are built on each chunk independently, rather than a global index across all data.                                                           |
----
